...
if ($result->num_rows > 0) {
    ...
    echo "<h6>Tag: {$row['tag']}</h6>";
    echo "<h6>Data da Reportagem: {$row['data_reportagem']}</h6>";
    echo "<h4>Descrição: {$row['descricao']}</h4>";
    echo "<p class=\"reportagem\" >Reportagem: {$row['reportagem']}</p>";
} else {
...
<div class="jumbotron text-center">
  <p class="footer">Todos os Direitos Reservados - 2023 - Projeto Integrador - Senac </p>
    <p class="footer">Criado por Alan, Jonas, Jean, Leonardo, Arthur, Carlos </p>
</div>
<footer>
